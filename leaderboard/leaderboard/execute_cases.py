...
class TestCase(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        print('ports:',int(args.port),int(args.trafficManagerPort))
    ...
    def run_cases(self, config):
        vector_path = self.args.vector_path
        scenario_vecs = np.load(vector_path)['arr_0']
        print('run_cases vecs:', scenario_vecs.shape)

        print("Run Scenario")
        print("Town:", config.town)
        self._load_and_wait_for_world(self.args, config.town, config.weather)
